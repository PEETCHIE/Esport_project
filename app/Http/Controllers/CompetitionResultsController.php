...
class CompetitionResultsController extends Controller
{
    ...
    public function minusScore($id)
    {
        try {
            ...
            $chk_team_r2 = DB::table('tournament_in_teams')
            ...
            if ($chk_team_r2->isNotEmpty()) {
                ...
                $minus = DB::table('competition_results')
    ...
    {
        try {
            $cp_ids = DB::table('tournament_in_teams')->where('t_id', $id)->pluck('cp_id')->first();
