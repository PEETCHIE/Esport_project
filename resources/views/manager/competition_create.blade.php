        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="text-4xl  p-4 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('managers_competition.store') }}" method="POST" enctype="multipart/form-data" id="registrationForm">
                        <div class="container mx-auto">
                            ...
                            <div class="grid grid-cols-4 grid-flow-row">
                                ...
                                <div class="cols mx-1  col-span-2"> 
                                    <x-input-label for="competition_end_date" class="block  text-sm font-medium text-gray-900 dark:text-white py-2">วันที่สิ้นสุดการแข่งขัน</x-input-label>
