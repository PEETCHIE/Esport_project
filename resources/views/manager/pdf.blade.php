...
<body class="font-Kanit ">
    <header>
        <div class="text-center"><img src="https://i.redd.it/karina-looks-so-cute-with-glasses-v0-ggqk3ewcjojc1.jpg?width=1010&format=pjpg&auto=webp&s=c9a1622b5f98379e21eac52944245436e090ca73"
            alt="" width="40%" height="40%"></div>
        <p class="text-md text-right" align="right">วันที่ {{ \Carbon\Carbon::parse($today)->format('d') }}
        ...
        <h4 align='center' class="text-xl text-red-400" style="color: red">ระบบการจัดการ การแข่งขัน E-Sport</h4>
