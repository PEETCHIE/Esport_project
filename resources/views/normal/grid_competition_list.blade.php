                        ...
                        <div class="mx-auto px-5 justify-center m-3">
                            <div
                                ...
                                <p class="my-4 pl-4 my-px font-bold text-white">วันที่เริ่มแข่งขัน :
                                    {{ $competition_list->start_date }}</p>
                                <p class="my-4 pl-4 my-px font-bold text-white">วันที่สิ้นสุดการแข่งขัน :
                                    {{ $competition_list->competition_end_date }}</p>
                                ...
                                <div class="mx-auto mx-12">
                                    <button type="button" data-modal-target="default-modal"
                                        ...
                                        class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-1 rounded m-1">รายละเอียด</button>
                                    ...
                                    <button type="submit"
                                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-1 rounded "><a
